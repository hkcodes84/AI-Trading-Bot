...
The bot is designed not only for directional trading, but also for **exchange inefficiency farming**.

It can:

- **catch spreads across different exchanges** when the same asset trades at different prices
- **farm funding rates** on perpetual futures platforms when funding becomes favorable
- rotate between **trend trading**, **spread trading**, and **funding farming** depending on market conditions
- monitor several major exchanges at once and route capital to the best opportunity

This makes it suitable for traders who want to combine **active trading** with **yield-oriented market inefficiency strategies**.
